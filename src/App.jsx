...
const SUPPORT_LINE = 'Protect your health. Keep your money. Know the truth.';
const SIGNATURE =
  'No ads. No sponsors. No agenda. This is What Doctors Wish You Knew.';
...
const EVIDENCE_DB = [
  {
    ...
    claim:
      'Sold online as "Nature\u2019s Ozempic" for blood sugar control and weight loss.',
    // The fast answer the person actually came for:
    worthIt: {
      health:
        'Possible small benefit for blood sugar and cholesterol. Not a treatment on its own.',
      money:
        '~$15–$30/month. Cheap as supplements go — but proven options may do more for less.',
      consider:
        'Daily pills, GI side effects are common, and it interacts with several prescriptions. Talk to your doctor before a long trial.',
    },
    // Each claim carries a source index → superscript footnote.
    whatWeKnow: [
      {
        text: 'It can modestly lower fasting blood sugar and long-term blood sugar (HbA1c) in studies.',
        source: 0,
      },
      {
        text: 'It can modestly lower LDL (\u201Cbad\u201D) cholesterol.',
        source: 1,
      },
      {
        text: 'A few small studies compared its blood-sugar effect to early diabetes drugs — but those trials were small and lower quality.',
        source: 0,
      },
      {
        text: 'Stomach upset (cramping, diarrhea, constipation) is common at typical doses.',
        source: 2,
      },
    ],
    ...
    adsLeaveOut: [
      {
        text: 'It works nothing like Ozempic. Ozempic is a GLP-1 drug; berberine mainly acts on a cell-energy pathway (AMPK). The \u201CNature\u2019s Ozempic\u201D name is marketing, not biology.',
        source: 3,
      },
      {
        text: 'Any weight-loss effect is small — it is not a weight-loss shortcut.',
        source: 0,
      },
      {
        text: 'It interacts with common prescriptions, and brand-to-brand strength and purity vary widely.',
        source: 2,
      },
    ],
    ...
    stillStudying: [
      {
        text: 'Whether the benefit lasts — most trials run only weeks to a few months.',
        source: 0,
      },
      {
        text: 'Whether it improves outcomes that matter (like heart attacks), not just lab numbers.',
        source: 0,
      },
      {
        text: 'How it compares head-to-head with proven prescription medicine.',
        source: 0,
      },
    ],
    verdict:
      "Real, but small. Won't change your life, definitely not Ozempic. Worth a chat with your doctor, not a miracle.",
    pcpAlign:
    ...
    citations: [
      {
        label:
          'Berberine & blood sugar (HbA1c, fasting glucose) — reviews & trials',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=berberine+glycemic+control+meta-analysis',
      },
      {
        label: 'Berberine & cholesterol/lipids — trials',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=berberine+lipid+lowering+randomized+controlled+trial',
      },
      {
        label: 'Berberine — side effects, interactions & supplement quality',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=berberine+safety+drug+interactions',
      },
      {
        label: 'Berberine mechanism (AMPK) vs. GLP-1 drugs',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=berberine+AMPK+mechanism',
      },
    ],
    videos: [
      {
        title: "What berberine actually does (and doesn't)",
        channel: 'Verified MD · add your curated video ID',
        embedId: null,
      },
    ],
  },
  {
    ...
    claim:
      'An all-in-one daily greens powder promising broad foundational health benefits.',
    whatWeKnow: [
    ...
    citations: [
      {
        label: 'Greens powders & health outcomes (PubMed)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=greens+powder+supplement+health+outcomes',
      },
      {
        label: 'Multivitamins & mortality — trials (PubMed)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=multivitamin+mortality+randomized+controlled+trial',
      },
    ],
    videos: [
      {
        title: 'Is an expensive greens powder worth it?',
        channel: 'Verified RD · add your curated video ID',
        embedId: null,
      },
    ],
  },
  {
    ...
    claim:
      'Cold water immersion sold for recovery, metabolism, mood, immunity and fat loss.',
    whatWeKnow: [
    ...
    citations: [
      {
        label: 'Cold water immersion & recovery — review (PubMed)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=cold+water+immersion+recovery+meta-analysis',
      },
      {
        label: 'Cold immersion & training gains (PubMed)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=cold+water+immersion+resistance+training+hypertrophy',
      },
    ],
    videos: [
      {
        title: 'What the cold-plunge evidence really shows',
        channel: 'Verified MD · add your curated video ID',
        embedId: null,
      },
    ],
  ...
  /* --- extra sample entries so category pages aren't empty --- */
  {
    ...
    grade: 'Minimal',
    bottomLine:
      'Cheap and low-risk to try — just keep your expectations modest.',
    ...
    priceVsProof: {
      ...
      detail:
        'Roughly $8–$20/mo. Low risk and cheap, so a reasonable trial — just keep expectations modest.',
    },
    pcpAlign:
    ...
    citations: [
      {
        label: 'Magnesium & sleep quality (PubMed)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=magnesium+sleep+quality+randomized',
      },
    ],
    videos: [
      {
        title: 'Magnesium and sleep: signal vs. hype',
        channel: 'Verified MD · add your curated video ID',
        embedId: null,
      },
    ],
  },
  {
    ...
    grade: 'Minimal',
    bottomLine:
      "Fascinating to watch, but there's no proof it improves your health if you don't have diabetes.",
    claim:
      "Wearable glucose monitors marketed to healthy people to 'optimize metabolism'.",
    whatWeKnow: [
    ...
    priceVsProof: {
      ...
      detail:
        'Monthly subscriptions add up. Educational and fun — but no evidence it improves outcomes in people without diabetes.',
    },
    pcpAlign:
    ...
    citations: [
      {
        label: 'CGM in non-diabetic adults (PubMed)',
        url: 'https://pubmed.ncbi.nlm.nih.gov/?term=continuous+glucose+monitoring+non-diabetic+healthy',
      },
    ],
    videos: [
      {
        title: 'Do healthy people need a CGM?',
        channel: 'Verified MD · add your curated video ID',
        embedId: null,
      },
    ],
...
const STATIC_PAGES = {
  'start-here': {
    title: 'Start Here',
    blurb:
      "How to read this site. We lead with the truth, name the myth gently, explain what's actually happening in your body, then leave you with one clear next step. Every claim gets a transparent grade, a plain-English summary, a price-vs-proof verdict, and links to the real research. We sell nothing and rank nothing for money.",
  },
  'evidence-policy': {
    title: 'Evidence Policy',
    blurb:
      'Grades reflect the strength, consistency and quality of human evidence — not how loudly something is marketed. We favor systematic reviews and randomized trials, name the uncertainty plainly, downgrade small or industry-funded studies, and re-grade as new evidence arrives. We say \u201Cimprove,\u201D not \u201Ccure.\u201D',
  },
  conflicts: {
    title: 'Conflicts of Interest',
    blurb:
      "We take no money from anyone whose products we grade — no supplement makers, device companies, or pharma. Any platform support is clearly labeled and only ever comes from non-health brands. And we celebrate other trustworthy sources: we're here to add light, not throw shade.",
  },
};
...
const GRADE_META = {
  Strong: {
    color: 'var(--g-strong)',
    glyph: '●●●●',
    note: 'Consistent, high-quality evidence',
  },
  Mixed: {
    color: 'var(--g-mixed)',
    glyph: '●●○○',
    note: 'Conflicting or moderate evidence',
  },
  Minimal: {
    color: 'var(--g-minimal)',
    glyph: '●○○○',
    note: 'Little reliable human evidence',
  },
  'No Evidence': {
    color: 'var(--g-none)',
    glyph: '○○○○',
    note: 'No credible supporting evidence',
  },
  'Potentially Dangerous': {
    color: 'var(--g-danger)',
    glyph: '⚠',
    note: 'Evidence of possible harm',
  },
};
...
function ClinicBanner({ clinic }) {
  ...
  return (
    ...
    >
      Brought to you by <strong>{prettifyClinic(clinic)}</strong>. Have
      questions about this evidence? Check in with your care team directly via
      your patient portal.
    </div>
  );
}
...
function LogoMark({ size = 64 }) {
  ...
  return (
    <svg
      ...
      viewBox="0 0 100 100"
      role="img"
      aria-label="WhatDoctorsWishYouKnew logo"
    >
      <circle
        cx="50"
        cy="50"
      ...
      />
      <path
        d="M50 33c-5-9-22-8-22 6 0 13 16 22 22 27 6-5 22-14 22-27 0-14-17-15-22-6z"
        fill="var(--trust)"
      />
      <path
        d="M55 26c6-5 12-4 12-4s-1 7-7 9c-3 1-5 0-5 0z"
        fill="var(--g-strong)"
      />
      <path
        d="M50 30c0-4 1-7 3-9"
        fill="none"
        stroke="var(--warm)"
        strokeWidth="2.4"
        strokeLinecap="round"
      />
      <path
        d="M30 52h7l4-9 5 17 5-12 3 4h11"
        fill="none"
        stroke="#FEFDF9"
        strokeWidth="3"
        strokeLinecap="round"
  ...
  return (
    <h1 className="font-display leading-none" style={{ fontWeight: 600 }}>
      ...
      >
        ...
        <span style={{ color: 'var(--trust)' }}>.com</span>
      </span>
    </h1>
  );
}
...
function BrandBanner({ onShareMission }) {
  return (
    <header className="no-print px-4 pt-7 pb-1 text-center">
      <div className="flex items-center justify-center gap-3 mb-1">
        <LogoMark size={44} />
        <TextWordmark />
      </div>
      <p
        className="font-display mx-auto text-base sm:text-lg italic"
        style={{ color: 'var(--trust-deep)' }}
      >
        {HERO_TAGLINE}
      </p>
      <p
        className="mx-auto mt-1 max-w-lg text-sm font-medium"
      ...
      <p
        ...
        style={{ color: 'var(--ink-soft)' }}
      >
        The truth your doctor wishes you knew — the honest answer you deserve.
      </p>
      <div className="mt-4 flex justify-center">
        <button
          onClick={onShareMission}
          className="btn rise inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold"
          style={{
        ...
        >
          ...
          Join the movement — share truth over hype
        </button>
      </div>
    </header>
  );
  ...
  return (
    <div className="no-print px-4">
      <div className="mx-auto mt-5 max-w-2xl">
        <div
          className="wd-search flex items-center gap-3 rounded-2xl border px-5 py-5 shadow-sm"
...
function CategoryNav({ active, onPick, variant = 'header' }) {
  return (
    <nav
      className={`no-print px-4 ${variant === 'header' ? 'mt-6' : 'mt-2'}`}
      ...
      <div className="mx-auto flex max-w-4xl flex-wrap justify-center gap-2">
        {CATEGORIES.map((c) => (
          <button
            ...
            className={`chip rounded-full border px-3.5 py-1.5 text-sm font-medium ${
              active === c.slug ? 'chip-active' : ''
            }`}
            style={{
              borderColor: 'var(--line)',
              color: active === c.slug ? 'var(--paper)' : 'var(--ink-soft)',
            }}
          >
            /{c.slug}
          </button>
...
function VideoEmbed({ video }) {
  return (
    <div
      ...
      style={{ borderColor: 'var(--line)', background: '#0a2c2e' }}
    >
        ...
        {video.embedId ? (
          ...
          >
            ...
            <span className="text-xs" style={{ opacity: 0.8 }}>
              Add a verified-clinician embed ID
            </span>
          </div>
        )}
      </div>
      <div className="px-3 py-2.5">
        <p className="text-sm font-medium" style={{ color: '#EAF4F3' }}>
          {video.title}
        </p>
        <p className="text-xs" style={{ color: '#92B3B0' }}>
          {video.channel}
        </p>
      </div>
    </div>
...
function Block({ title, items, tone, citations }) {
  ...
  return (
    <div className="mt-6">
      <p className="label-eyebrow" style={{ color: 'var(--ink-soft)' }}>
        {title}
      </p>
      <ul className="mt-2 space-y-2">
        {items.map((item, i) => {
          ...
          const cite =
            srcIdx != null && citations && citations[srcIdx]
              ? citations[srcIdx]
              : null;
          return (
            <li
        ...
        <div className="print-stack flex flex-col gap-6 lg:flex-row">
          ...
          <article className="wd-card print-area rise w-full p-6 sm:p-8 lg:w-3/5">
            {item.recommendation && REC_META[item.recommendation] && (
              ...
              >
                <span style={{ fontSize: 16 }}>
                  {REC_META[item.recommendation].dot}
                </span>
                <span
                  className="text-sm font-bold uppercase"
                  style={{
                    color: REC_META[item.recommendation].color,
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                <p
                  className="label-eyebrow no-print"
                  style={{ color: 'var(--ink-soft)' }}
                >
                  Evidence Card
                </p>
            ...
            >
              <p className="label-eyebrow" style={{ color: '#9DB9B0' }}>
                The Verdict
              </p>
              <p
                ...
                {[
                  {
                    icon: '❤️',
                    label: 'Your health',
                    val: item.worthIt.health,
                  },
                  { icon: '💰', label: 'Your money', val: item.worthIt.money },
                  {
                    icon: '🧐',
                    label: 'Before you try it',
                    val: item.worthIt.consider || item.worthIt.time,
                  },
                ].map((w) => (
                  <div
                    key={w.label}
            ...
            {item.stillStudying && (
              <Block
                title="Still being studied"
                tone="dont"
                items={item.stillStudying}
                citations={item.citations}
              />
            )}
            ...
            {!item.verdict && item.priceVsProof && (
              ...
              >
                <p className="label-eyebrow" style={{ color: 'var(--trust)' }}>
                  Price vs. Proof
                </p>
                <p
                  ...
                  style={{ color: 'var(--ink)' }}
                >
                  {item.priceVsProof.verdict}
                </p>
                <p
                  className="mt-1 text-sm"
                  style={{ color: 'var(--ink-soft)' }}
                >
                  {item.priceVsProof.detail}
                </p>
              </div>
            )}
            ...
            <div className="mt-6">
              ...
              <p className="mb-2 text-xs" style={{ color: 'var(--ink-soft)' }}>
                Every claim above links here. Tap any source to see the evidence
                yourself.
              </p>
              <ol
            ...
            >
              <p className="label-eyebrow" style={{ color: 'var(--trust)' }}>
                🩺 What I'd do if you were my patient
              </p>
              <p
              ...
              <p
                ...
                style={{ color: 'var(--ink-soft)' }}
              >
                This is here to inform your decision — it doesn't replace your
                own clinician.
              </p>
            </div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              <button
                onClick={onPrint}
                className="btn no-print rounded-lg px-5 py-2.5 text-sm font-semibold"
              ...
              <button
                onClick={onShare}
                className="btn no-print rounded-lg border px-5 py-2.5 text-sm font-semibold"
                style={{
                  borderColor: 'var(--trust)',
                  color: 'var(--trust)',
                ...
                >
                  ...
                  {others.map((o) => (
                    <button
                      ...
                      className="chip rounded-full border px-3 py-1"
          ...
          {/* RIGHT 40% */}
          <aside
            className="no-print rise w-full space-y-5 lg:w-2/5"
            style={{ animationDelay: '.08s' }}
          >
            <div className="wd-card p-5">
              <p className="label-eyebrow" style={{ color: 'var(--trust)' }}>
                Credentialed Insights
              </p>
              <p
            ...
            <div
              ...
              style={{ background: 'var(--trust-deep)' }}
            >
              <p className="label-eyebrow" style={{ color: '#8FC3C0' }}>
                Platform Supporter
              </p>
              <div className="mt-3 flex items-center gap-3">
                <div
                  className="flex h-11 w-11 items-center justify-center rounded-lg font-display text-lg"
                  style={{
                    background: '#EAF4F3',
                ...
                <div>
                  <p className="font-semibold" style={{ color: '#F4F1E8' }}>
                    NorthLeaf Stationery Co.
                  </p>
                  <p className="text-xs" style={{ color: '#92B3B0' }}>
                    Placeholder · non-health brand
                  </p>
                </div>
              </div>
              <p className="mt-3 text-xs" style={{ color: '#92B3B0' }}>
                Support keeps this platform free and ad-free. Supporters are
                never health or supplement brands, and never influence a grade.
              </p>
            </div>
          </aside>
        </div>
    ...
    <section className="px-4">
      <div className="mx-auto mt-8 max-w-3xl">
        ...
        <div className="wd-card rise p-8 text-center sm:p-10">
          <p className="label-eyebrow" style={{ color: 'var(--warm)' }}>
            Open Queue · Not yet clarified
          </p>
          <h2
            className="font-display mx-auto mt-3 max-w-xl text-2xl sm:text-3xl"
          ...
          <p
            ...
            style={{ color: 'var(--ink-soft)' }}
          >
            Your search has been added to our open queue. The more people ask
            about a topic, the sooner our clinicians cut through the hype and
            clarify it.
          </p>

          <div
            className="my-7 rounded-xl p-5"
          ...
          >
            ...
            <p
              ...
              style={{ color: 'var(--ink-soft)' }}
            >
              Share it. Every person who searches a topic moves it up the queue
              — and soon, subscribers and verified clinicians will be able to
              give it even more weight.
            </p>
            <button
              onClick={() => onShare(term)}
              className="btn mt-4 rounded-lg px-5 py-2.5 text-sm font-semibold"
              style={{ background: 'var(--trust)', color: '#F4F1E8' }}
            >
              ↗ Share this search
            </button>
      ...
      <div className="mx-auto mt-8 max-w-3xl">
        <div className="wd-card rise p-7 sm:p-9">
          ...
          {topics.length > 0 ? (
            <div className="mt-6">
              <p className="label-eyebrow" style={{ color: 'var(--ink-soft)' }}>
                Clarified topics in this category
              </p>
              <ul
            ...
            !staticPage && (
              <p className="mt-4 text-sm" style={{ color: 'var(--ink-soft)' }}>
                No clarified topics here yet — search a claim above to add it to
                the open queue.
              </p>
            )
          )}
  ...
  const steps = [
    {
      n: '1',
      t: 'Search a claim',
      d: 'Any supplement, test, or health trend.',
    },
    {
      n: '2',
      t: 'See the evidence grade',
      d: 'Strong, Mixed, Minimal, or worse — at a glance.',
    },
    {
      n: '3',
      t: 'Get the honest verdict',
      d: 'Plain-English truth and price-vs-proof.',
    },
  ];
  return (
    <section className="px-4">
      <div className="mx-auto mt-6 max-w-3xl">
        ...
        <p
          className="label-eyebrow text-center mt-8"
          style={{ color: 'var(--ink-soft)' }}
        >
          Recently clarified
        </p>
        <div className="mt-3 grid gap-3 sm:grid-cols-3">
          {featured.map((t, i) => (
            <button
              key={t.id}
              onClick={() => onSelect(t.title)}
              className="wd-card btn rise p-4 text-left"
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {t.recommendation && REC_META[t.recommendation] && (
                  <span
                    ...
                    style={{
                      background: REC_META[t.recommendation].bg,
                      color: REC_META[t.recommendation].color,
                    }}
                  >
                    {REC_META[t.recommendation].dot}{' '}
                    {REC_META[t.recommendation].label}
                  </span>
                )}
              </div>
              <p
...
function Footer({ active, onPick }) {
  return (
    <footer className="no-print mt-16 px-4 pb-12 pt-10 hairline">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p
          className="font-display mt-2 text-base italic"
          style={{ color: 'var(--trust-deep)' }}
        >
          {SIGNATURE}
        </p>
        <p
          ...
          style={{ color: 'var(--ink-soft)' }}
        >
          Ad-free and consumer-unbiased. Educational only — not medical advice.
          Always align decisions with your own clinician.
        </p>
        <CategoryNav active={active} onPick={onPick} variant="footer" />
      </div>
    </footer>
  );
}
...
export default function App() {
  ...
  const shareCard = useCallback(
    (item) => {
      ...
      if (navigator.share) {
        navigator
          .share({ title: `WDWYK: ${item.title}`, text, url })
          .catch(() => {});
  ...
  const shareTerm = useCallback(
    (term) => {
      ...
      if (navigator.share) {
        navigator
          .share({ title: 'What Doctors Wish You Knew', text, url })
          .catch(() => {});
      } else if (navigator.clipboard) {
        navigator.clipboard
          .writeText(`${text}\n${url}`)
  ...
  return (
    <div className="wdwyk-root">
      ...
      <BrandBanner onShareMission={() => shareTerm('the mission')} />
      <SearchBar
        value={query}
      ...
      <Footer active={category} onPick={pickCategory} />

      {toast && (
        <div
          className="toast no-print fixed bottom-6 left-1/2 z-50 -translate-x-1/2 rounded-full px-5 py-3 text-sm font-medium shadow-lg"
